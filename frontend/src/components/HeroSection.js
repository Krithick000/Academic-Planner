      ...
      >
        ...
        >
          <Button 
            ...
            size="lg"
            className="bg-primary text-primary-foreground hover:bg-primary/90 transform transition-all duration-300 text-lg px-8 py-4 group shadow-lg hover:shadow-xl"
          >
            Join the Waitlist
